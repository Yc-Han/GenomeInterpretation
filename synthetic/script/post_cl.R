...
writeLines(sourceseqs, "synthetic/sourceseqs.csv")
...
# Export needed objects to each cluster worker.
# Make sure you include everything your mutate_sequence() and insert_downloaded_genes() need:
# - 'mutate_sequence' function
# - 'insert_downloaded_genes' function
# - 'codon.dict'
# - 'labelled_yes_orders'
# etc.
clusterExport(cl, c("mutate_sequence", 
                    "insert_downloaded_genes", 
                    "codon.dict",
                    "permute_sequence",
                    "labelled_yes_orders",
                    "startcodon",
...
parLapply(cl, sourceseqs, function(seqpath) {
...
# Stop the cluster once completed
stopCluster(cl)